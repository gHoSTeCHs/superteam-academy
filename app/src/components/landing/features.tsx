...
const FEATURES: Feature[] = [
  {
    ...
    description:
      "Write real Solana programs in the browser with instant feedback, test cases, and hints.",
  ...
  },
  {
    ...
    description:
      "Earn verifiable NFT certificates stored on Solana. Prove your skills with on-chain proof.",
  ...
  },
  {
    ...
    description:
      "Earn XP for every lesson and challenge. Compete on the leaderboard and unlock achievements.",
  ...
  },
  {
    ...
    description:
      "Learn in English, Portuguese, or Spanish. All courses available in your preferred language.",

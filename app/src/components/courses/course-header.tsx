import { BookOpenIcon, ClockIcon, UsersIcon, ZapIcon, LayersIcon } from 'lucide-react';
  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-5">
        <StatCard icon={LayersIcon} value={course.modules.length} label="Modules" />
        <StatCard icon={BookOpenIcon} value={lessons.length} label="Lessons" />
        <StatCard icon={ClockIcon} value={`${totalMinutes}m`} label="Total Time" />

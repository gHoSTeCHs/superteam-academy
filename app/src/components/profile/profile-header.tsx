        ...
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              ...
              {isOwnProfile && (
                <Badge variant="reward" className="border-0 bg-white/15 text-[9px] text-white backdrop-blur-sm">
                  You
                </Badge>
              )}
            </div>
            <div className="mt-1 flex items-center gap-3">
              ...
              <span className="flex items-center gap-1 text-[11px]" style={{ color: 'rgba(247, 234, 203, 0.5)' }}>
                <CalendarIcon className="size-3" />
                <span style={{ fontFamily: 'var(--font-body)' }}>Joined {joinDate}</span>
              </span>
            </div>
          </div>
        </div>
